      ...
      <div>
        ...
        >
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            {/* Conditionally render message based on score */}
            {score < 10 && (
              <p
                className={`text-[2rem] leading-[150%] transition-all duration-300 ${
                  darkMode ? "text-light-bluish" : "text-dark-navy"
                }`}
              >
                <marquee direction="right">Try to improve! Better! Next Time.</marquee>
              </p>
            )}
            {score > 10 && (
              <p
              ...
              >
                <marquee direction="right">You did a Good Job!</marquee>
              </p>
            )}
          </div>
        </div>
